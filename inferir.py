...
Uso:
    python infer.py --duration 5                    # Predicciones aleatorias (05seg, overlap 0.5)
    ...
    python infer.py --duration 30 --train-duration 5 # Cross-duration: modelo 05seg, test 30seg
"""
